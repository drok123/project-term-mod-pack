...
current `ProjectTermModPack` Machines/Arc Pulse baseline. Static evidence is
recorded separately from prior atmosphere-branch game evidence. A Mods-menu
screenshot of this combined identity and controlled same-location day/night
A/B captures remain pending.
