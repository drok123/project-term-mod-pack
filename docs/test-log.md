...
> Entries below 2026-09-26 preserve evidence from the earlier atmosphere-only
> branch, which used `ProjectTermModPackB42` and 0.3.x version markers. They do
> not prove the combined 0.2.0 `ProjectTermModPack` package. Re-run the
